package com.liuzengyu.examples.es.demo.service;

import com.liuzengyu.examples.es.demo.entity.Book;
import com.liuzengyu.examples.es.demo.entity.EsEntity;
import com.liuzengyu.examples.es.demo.util.EsUtil;
